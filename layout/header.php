      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a href="https://sle4ever.com" class="nav-link" target="_blank">SLE4ever.com</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="https://www.facebook.com/groups/hackerspacemmu/" target="_blank">Hackerspace MMU FB Group</a>
            </li>
          </ul>
